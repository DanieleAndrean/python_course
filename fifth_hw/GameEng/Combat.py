...
def combatTest(Trainer,enemyPk):
    ...
    stats={"NTurns":nTurns,"PercHP":percHP,"Pokemon":Trainer.PokemonList[0].Name,
           "PokemonLvl":Trainer.PokemonList[0].Level,"PokemonActStats":Trainer.PokemonList[0].actualStats,
           "PokemonTypes":Trainer.PokemonList[0].Types,"EnemyPk":enemyPk.Name,"EnemyLvl":enemyPk.Level,
           "EnemyActStats":enemyPk.actualStats,"EnemyTypes":enemyPk.Types}
    match CbtEngine.state.name:
        case "Victory":
            exitcon="Vct"
        case "Defeat":
